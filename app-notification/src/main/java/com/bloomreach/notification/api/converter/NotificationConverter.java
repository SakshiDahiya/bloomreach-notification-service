...
public final class NotificationConverter {
    ...
    public static Notification toNotification(CreateNotificationRequest request) {
    ...
    public static CreateNotificationResponse toResponse(com.bloomreach.notification.service.model.NotificationResponse response) {
        return new CreateNotificationResponse()
                .id(response.id());
    }

    private static NotificationPayload toPayload(CreateNotificationRequest request) {
    ...
    private static NotificationPayload emailPayload(EmailPayload payload) {
        if (payload == null) {
    ...
    private static NotificationPayload webappPayload(WebappPayload payload) {
        if (payload == null) {
